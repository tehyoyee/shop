...
class ItemServiceTest {
	...
	List<MultipartFile> createMultipartFiles() throws Exception {
		...
		for(int i=0;i<5;i++){
			String path = "C:/Users/Taehyeong/intelliJ/shop/item";
	...
	void saveItem() throws Exception {
		...
		for (MultipartFile multipartFile : multipartFileList) {
			...
			System.out.println("itemImgList.get(0)" + itemImgList.get(0).getOriImgName());
//			System.out.println("multipartFile.get = " + multipartFile.get);
